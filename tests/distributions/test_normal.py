...
class TestNormal(unittest.TestCase):
    ...
    def test_init(self):
        ...
        Normal(mean=paddle.cast(paddle.to_tensor([32, 1]), 'float32'),
               logstd=paddle.cast(paddle.to_tensor([32, 1, 3]), 'float32'))
        Normal(mean=paddle.cast(paddle.to_tensor([32, 1]), 'float32'),
               std=paddle.cast(paddle.to_tensor([32, 1, 3]), 'float32'))
    ...
    def test_distribution_shape(self):
        utils.test_and_save_distribution_img(self._Normal_logstd)