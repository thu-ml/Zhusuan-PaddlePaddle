...
class Concrete(Distribution):
    def __init__(self,
        ...
        super(Concrete, self).__init__(dtype,
                             param_dtype,
                             is_continues,
                             is_reparameterized,
    ...
    def _sample(self, n_samples=1, **kwargs):
        ...
        sample_ = paddle.nn.functional.softmax((_probs + gumbel) / _temperature)
    ...
    def _log_prob(self, sample=None):
        ...
        temp = _probs - _temperature * log_given
        ...
        log_prob = lgamma_n + (n - 1) * log_temperature + \
                   fluid.layers.reduce_sum(temp - log_given, dim=-1) - \
                   n * paddle.logsumexp(temp, axis=-1)
